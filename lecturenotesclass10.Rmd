...
```
It is false 59.88% of the time, and true 40.12% of the time, so my hypothesis that it was somewhat unlikely was true. The match still happens often but it is more unlikely than not.
